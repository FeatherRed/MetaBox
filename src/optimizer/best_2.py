...
class DE_best_2(Basic_Optimizer):
    def __init__(self, config):
        super(DE_best_2, self).__init__(config)
    ...
    def __update(self, problem):
        ...
        v = self.__best_2(self.__population)
    ...
    def __best_2(self, group):
        ...
        duplicate = np.where((r3 == rb) + (r3 == r1) + (r3 == r2) + (r3 == np.arange(NP)))[0]
        while duplicate.shape[0] > 0 and count < 25:
        ...
        duplicate = np.where((r4 == rb) + (r4 == r1) + (r4 == r2) + (r4 == r3) + (r4 == np.arange(NP)))[0]
        while duplicate.shape[0] > 0 and count < 25:
